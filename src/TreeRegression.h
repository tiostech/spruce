...
namespace spruce
{
  ...
  public:
    ...
    bool findBestSplitCrystalCost(size_t nodeID, std::vector<size_t> &possible_split_varIDs);
    void findBestSplitValueCrystalCost(size_t nodeID, size_t varID, size_t num_samples_node, double &best_value, size_t &best_varID, double &best_decrease);
    ...
    void findBestSplitValueAbsoluteCostApprox(size_t nodeID, size_t varID, size_t num_samples_node, double &best_value, size_t &best_varID, double &best_decrease, std::vector<double> possible_split_values, std::vector<double> &sums_right, std::vector<size_t> &n_right);
